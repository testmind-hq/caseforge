...
| AT-236 | doctor shows bedrock section | `caseforge doctor` | "AWS Bedrock" in output |
| AT-237 | generate --no-ai works with bedrock config | see script | cases written, no error |
